...
do
	...
	echo $WORLD
	SLOC_dest="/home/jay/data/remote_images/$set_name/${set_name}_$WORLD"
...
#  	  sloc_log:=$log last_control_output:=$lastFile port:=55560"
	...
	mkdir -p $SLOC_dest
  	...
  	# Copy features to tmp feature folder
  	mkdir $SLOC_dest/features
  	chmod 775 $SLOC_dest/features
  	echo "Copying features to folder"
  	cp -r /home/jay/data/remote_features/* $SLOC_dest/features/
