...
WORLDFILES="/home/jay/autopilot_ws/src/autopilot/worlds/oa_challenges_train_discrete_tmp/*.world"
# whether the trajectory is a success or not is saved log file. 
rm -rf $log
# SAVINGDIR="remote_images/debug_2/"
SAVINGDIR="remote_images/discrete_expert_2"
logdir="/home/jay/data/$SAVINGDIR/"
log="$logdir/log-discrete-expert"
...
do
	...
	COMMAND="roslaunch autopilot oa_challenge_discrete_expert.launch sloc:=$SLOC current_world:='/oa_challenges_train/$FNAME' sloc_log:=$log"
	echo $COMMAND
