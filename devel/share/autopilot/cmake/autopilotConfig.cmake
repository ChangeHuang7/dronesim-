...
if("TRUE" STREQUAL "TRUE")
  set(autopilot_SOURCE_PREFIX /home/jay/autopilot_ws/src/autopilot)
  set(autopilot_DEVEL_PREFIX /home/jay/autopilot_ws/devel)
  ...
  set(autopilot_INSTALL_PREFIX /home/jay/autopilot_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'autopilot' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'jay <jay@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'autopilot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jay/autopilot_ws/src/autopilot/${idir}'.  Ask the maintainer 'jay <jay@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${autopilot_dep}_FOUND)
      find_package(${autopilot_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${autopilot_dep} REQUIRED ${depend_list})
  endif()
