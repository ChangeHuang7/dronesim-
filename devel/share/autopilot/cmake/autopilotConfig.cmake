...
if("TRUE" STREQUAL "TRUE")
  set(autopilot_SOURCE_PREFIX /home/jay/autopilot_temp/dronesim-/src/autopilot)
  set(autopilot_DEVEL_PREFIX /home/jay/autopilot_temp/dronesim-/devel)
  ...
  set(autopilot_INSTALL_PREFIX /home/jay/autopilot_temp/dronesim-/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'autopilot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jay/autopilot_temp/dronesim-/src/autopilot/${idir}'.  Ask the maintainer 'jay <jay@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jay/autopilot_temp/dronesim-/devel/lib;/opt/ros/indigo/lib)
